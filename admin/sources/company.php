...
function save_capnhap(){
	...
	foreach ($config["lang"] as $key => $value)  {
 			...
 			$data['tieude_'.$value] = magic_quote($_POST['tieude_'.$value]);
	...
	$data['mst'] = magic_quote($_POST['mst']);		
	...
	if($logore = upload_image("file2", 'jpg|png|gif|jpeg|JPEG|JPG|PNG|GIF',_upload_company,$file_name2)){
