...
function save($c,$act){
	...
	if($d->num_rows()!=0){
		...
		if($photo1 = upload_image("file1", 'jpg|png|gif|jpeg|JPEG|JPG|PNG|GIF|mp3|MP3|MP4|mp4',_upload_tinnho,$file_name1)){
		...
		if($photo2 = upload_image("file2", 'jpg|png|gif|jpeg|JPEG|JPG|PNG|GIF|mp3|MP3|MP4|mp4',_upload_tinnho,$file_name2)){
		...
		if($photo3 = upload_image("file3", 'jpg|png|gif|jpeg|JPEG|JPG|PNG|GIF|mp3|MP3|MP4|mp4',_upload_tinnho,$file_name3)){
			...
			if($d->num_rows()>0){
				...
				delete_file(_upload_tinnho.$row['photo3']);
