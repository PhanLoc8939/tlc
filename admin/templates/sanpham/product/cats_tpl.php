  ...
  <div class="row">
                ...
                if (count($items) != 0) {
                  foreach ($items as $k => $v) { ?>
                    <tr>
                      ...
                      <td><a href="index.php?com=product&act=delete_cat&id=<?= $v['id'] ?><?= $chuoi_noi_curpage1 ?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                    </tr>
                <?php }
                } ?>
              </tbody>
    ...
    <div class="col-md-12 margin_bottom_10px pt-10">
      <div class="col-md-4 paging_0px">
        <a href="index.php?com=product&act=add_cat<?= $chuoi_noi_curpage ?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm</a>
        <a href="./index.php" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a>
      </div>
