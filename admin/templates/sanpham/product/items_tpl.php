...
<!-- Breadcrumbs Start -->
<h4 class="header-title"><a href="index.php?com=product&act=man">Sản Phẩm</a></h4>
<!-- Breadcrumbs End -->
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="inner">
      ...
      <!-- Title Bar Start -->
      <div class="title-bar">
        <div class="col-md-12" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">
      ...
      <div class="title-bar" style="padding-bottom:0px;">
        ...
        <div class="col-md-12 paging_0px">
                ...
                <div class="data-tables w-full">
                  ...
                  <table id="dataTable" class="text-center">
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            <td><input type="checkbox" name="chon" id="chon" value="<?= $v['id'] ?>" /></td>
                            <td><?= $v['stt'] ?></td>
                            <td>
                              <b class="cap1">Cấp 1:
                                <?php
                              ...
                              <b class="cap3">Cấp 3:
                                <?php
                                $sql_danhmuc1 = "select ten from table_product_cat where id='" . $v['id_cat2'] . "'";
                                $result = mysql_query($sql_danhmuc1);
                                $item_danhmuc1 = mysql_fetch_array($result);
                                echo @$item_danhmuc1['ten_vi'];
                                ?>
                            ...
                            <td><a href="index.php?com=product&act=edit&id=<?= $v['id'] ?><?= $chuoi_noi_curpage ?>" style="text-decoration:none;"><img src="<?= _upload_sanpham . $v['photo'] ?>" border="1" class="sp_img" style="width:90px;" /></a></td>
                            <td><a href="index.php?com=product&act=edit&id=<?= $v['id'] ?><?= $chuoi_noi_curpage ?>" style="text-decoration:none;"><?= $v['ten_vi'] ?></a></td>
                            <!-- <td><a href="index.php?com=product&act=man_photo&id_cat=<?= $v['id'] ?>&type=sanpham"><i class="fa fa-plus"></i> Add</a></td>
                            <td><a href="index.php?com=product&act=man_photocauhinh&id_cat=<?= $v['id'] ?>&type=sanpham"><i class="fa fa-plus"></i> Add cấu hình</a></td> -->
                            <td><a class="clickchange" thaydoiloai="spmoi" thaydoitable="table_product" thaydoiid="<?= $v['id'] ?>" id="idcssspmoi<?= $v['id'] ?>"><img src="<?= ($v['spmoi'] == 1) ? 'media/images/yes-km.gif' : 'media/images/no-km.gif' ?>" border="0" /></a></td>
                            <!-- <td><a class="clickchange" thaydoiloai="noibat" thaydoitable="table_product" thaydoiid="<?= $v['id'] ?>" id="idcssnoibat<?= $v['id'] ?>"><img src="<?= ($v['noibat'] == 1) ? 'media/images/yes-km.gif' : 'media/images/no-km.gif' ?>" border="0" /></a></td>
                            <td><a class="clickchange" thaydoiloai="hot" thaydoitable="table_product" thaydoiid="<?= $v['id'] ?>" id="idcsshot<?= $v['id'] ?>"><img src="<?= ($v['hot'] == 1) ? 'media/images/yes-km.gif' : 'media/images/no-km.gif' ?>" border="0" /></a></td>
                            <td><a class="clickchange" thaydoiloai="spbanchay" thaydoitable="table_product" thaydoiid="<?= $v['id'] ?>" id="idcssspbanchay<?= $v['id'] ?>"><img src="<?= ($v['spbanchay'] == 1) ? 'media/images/yes-km.gif' : 'media/images/no-km.gif' ?>" border="0" /></a></td>
                            <td><a class="clickchange" thaydoiloai="sale" thaydoitable="table_product" thaydoiid="<?= $v['id'] ?>" id="idcsssale<?= $v['id'] ?>"><img src="<?= ($v['sale'] == 1) ? 'media/images/yes-km.gif' : 'media/images/no-km.gif' ?>" border="0" /></a></td> -->
                            <td><a class="clickhienthi" thaydoiloai="hienthi" thaydoitable="table_product" thaydoiid="<?= $v['id'] ?>" id="idcsshienthi<?= $v['id'] ?>"> <img src="<?= ($v['hienthi'] == 1) ? 'media/images/active_1.png' : 'media/images/active_0.png' ?>" border="0" /></a></td>
                            <td><a href="index.php?com=product&act=edit&id=<?= $v['id'] ?><?= $chuoi_noi_curpage ?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>
                            <td><a href="index.php?com=product&act=delete&id=<?= $v['id'] ?><?= $chuoi_noi_curpage ?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                          </tr>
                      <?php
                        }
                      }
