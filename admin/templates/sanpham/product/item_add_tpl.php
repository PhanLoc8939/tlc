...
<!-- Breadcrumbs Start -->
<h4 class="header-title"><a href="index.php?com=product&act=add_cat">Sản Phẩm</a></h4>
<!-- Breadcrumbs End -->
	...
	<div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="inner">
			...
			<form method="post" name="frm" action="index.php?com=product&act=save<?= $chuoi_noi_curpage ?>" enctype="multipart/form-data" class="basic-form inline-form">
				...
				<!-- <?php if ($_REQUEST['act'] == 'edit') { ?>
					<div class="col-md-2"><label>Hình (Trang trong) hiện tại</label></div>
					<div class="col-md-10"><img src="<?= _upload_sanpham . $item['photo1'] ?>" width="100%" alt="NO PHOTO" /><br /><br /></div>
				<?php } ?>

				<div class="clearfix"></div>
				<div class="col-md-2"><label>Hình ảnh (Trang trong)</label></div>
				<div class="col-md-10">

					<input type="file" name="file2" />
					<span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp; Ảnh chuẩn: Width:1920px - Height:1080px.</span>
					<br /><br />
				</div>
				...
				<!-- 
        			<div class="col-md-2"><label>Màu sản phẩm </label></div>
        			<div class="col-md-10"><input type="color" style="    -webkit-appearance: square-button;padding:0;width: 120px;height: 40px;background-color: buttonface;border-width: 1px;border-style: solid;border-color: rgb(169, 169, 169);border-image: initial;" name="mausac" id="mausac" value="<?= $item['mausac'] ?>" placeholder="Màu sắc" />
        			</div>

        			<div class="clearfix"></div> -->
				<div class="col-md-2 pt-10"><label>Danh mục cấp 1 </label></div>
				...
				<div class="col-md-1"><input type="checkbox" name="tinhtrang" class="icheck-blue" <?= (!isset($item['tinhtrang']) || $item['tinhtrang'] == 1) ? 'checked="checked"' : '' ?> /> <span class="hienthi_text">Còn hàng</span></div>

				<div class="col-md-1"><input type="checkbox" name="hienthi" class="icheck-blue" <?= (!isset($item['hienthi']) || $item['hienthi'] == 1) ? 'checked="checked"' : '' ?> /> <span class="hienthi_text">Hiển thị</span></div> -->
				...
				?>
					...
					<div class="tab-pane <?= $active ?>" id="tab<?= $value ?>">
						...
						<div class="col-md-2"><label>Mô tả <?= $config["langs"][$value] ?></label></div>
						<div class="col-md-10"><textarea class="w-full txt-area" name="mota_<?= $value ?>" cols="50" rows="6" placeholder="Mô tả"><?= $item['mota_' . $value] ?></textarea></div>
						<div class="clearfix"></div>
						<br />
						...
						<div class="col-md-10"><textarea class="w-full txt-area" name="noidung_<?= $value ?>" cols="50" rows="6" placeholder="Nội dung"><?= $item['noidung_' . $value] ?></textarea></div>
						<script type="text/javascript">
