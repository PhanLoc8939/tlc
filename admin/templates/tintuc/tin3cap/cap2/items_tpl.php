...
<div class="row breadcrumbs">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <ul class="breadcrumbs">
      ...
      <li><a href="index.php?com=tin3cap&act=man_cat1">Danh mục bài viết</a></li>
    </ul>
  </div>
</div>
<!-- Breadcrumbs End -->
            ...
            <div class="inner">
              ...
              <div class="title-bar">
                <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
                 <h4><a href="index.php?com=tin3cap&act=add_cat1<?=$chuoi_noi_curpage2?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Danh mục bài viết</a></h4>      
               </div>
...
<!--              <div class="title-bar">
            ...
            if(count($items)!=0){
              foreach($items as $k=>$v){
                ...
                <tr>
                  ...
                  <td style="width:5%"><a href="index.php?com=tin3cap&act=edit_cat1&id=<?=$v['id']?><?=$chuoi_noi_curpage2?>"><img src="<?=_upload_tin3cap.$v['photo']?>" border="1" class="sp_img" style="width:180px;height:auto" /></a></td> 
                  <td style=" width:20%;">
                   <p><b><?php
                 ...
                 <td style="width:5%;"><a class="clickchange" thaydoiloai="noibat"   thaydoitable="table_tin3cap_cat"  thaydoiid="<?=$v['id']?>" id="idcssnoibat<?=$v['id']?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>
                 
                 <td style="width:5%;"><a class="clickhienthi" thaydoiloai="hienthi"   thaydoitable="table_tin3cap_cat" thaydoiid="<?=$v['id']?>" id="idcsshienthi<?=$v['id']?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
     ...
     <div class="col-md-12 margin_bottom_10px">
      <div class="col-md-4 paging_0px">                  
        <a href="index.php?com=tin3cap&act=add_cat1<?=$chuoi_noi_curpage2?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Danh mục bài viết</a>
