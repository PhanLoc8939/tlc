  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tin3cap&act=man">Dự án</a></li>
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
              ...
              <?php
				...
				function get_main_category($a)

					{
						...
						$sql="select * from table_tin3cap_cat where com='cat' and id='1' order by stt asc,id desc";
              ...
              <form method="post" name="frm" action="index.php?com=tin3cap&act=save<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">
                    ...
                    <div class="col-md-10"><img src="<?=_upload_tin3cap.$item['photo']?>"  width="274" alt="NO PHOTO" /><br /><br /></div>
                ...
                <div class="clearfix"></div>
                    <div class="col-md-2"><label>Chọn hình</label></div>

                    <div class="col-md-10">

                        <input type="file" name="file" /> 

                        <span class="description">Type: PNG|JPG|JPGE. Kích thước chuẩn: 600x600 (theo px)</span>
                   ...
                   <!--  <?php if ($_REQUEST['act']=='edit'){?>
                    ...
                    <div class="col-md-10"><img src="<?=_upload_tin3cap.$item['icon']?>"  width="274" alt="NO PHOTO" /><br /><br /></div>

                    <?php }?>

                    <div class="col-md-2"><label>Chọn icon</label></div>

                    <div class="col-md-10">

                        <input type="file" name="file1" /> 

                        <span class="description">Type: PNG|JPG|JPGE</span>
...
<!-- 
                <div class="clearfix"></div>
                       ...
                       <div class="col-md-10"><input type="text" name="tenkhongdau" id="tenkhongdau" value="<?=$item['tenkhongdau']?>" placeholder="URL" /></div>
 -->
         ...
         <!--               <div class="col-md-2"><label>Màu chữ</label></div>

                <div class="col-md-10"><input style="    width: 40px;
    height: 40px;" type="color" name="h1_vi" id="h1_vi" value="<?=$item['h1_vi']?>" placeholder="" /></div>
 -->
