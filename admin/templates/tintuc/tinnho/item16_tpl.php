  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man16">Danh sách tag</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="inner">
            ...
            <div class="title-bar"> 
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<h4><a href="index.php?com=tinnho&act=add16<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Tag</a></h4>      
              </div>
              <div class="col-md-4 paging_0px">  
              	<form action="index.php?com=tinnho&act=man16<?=$chuoi_noi_curpage?>" method="post" class="inline-form">
           ...
           <!--         <th>Hình</th> -->
               <!--   <th style="width:5%;">Nổi bật</th> -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=tinnho&act=edit16&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten_vi']?></a></td>

            <!--   <td><a href="index.php?com=tinnho&act=edit16&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_tinnho.$v['download']?>" width="150px"/></a></td> -->
                ...
                <!--    <td style="width:5%;"><a class="clickchange" thaydoiloai="tinmoi"   thaydoitable="table_tinnho"  thaydoiid="<?=$v['id']?>" id="idcsstinmoi<?=$v['id']?>"><img src="<?=($v['tinmoi']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>
                   -->  <td style="width:5%;"><a class="clickhienthi" thaydoiloai="hienthi"   thaydoitable="table_tinnho" thaydoiid="<?=$v['id']?>" id="idcsshienthi<?=$v['id']?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
                    <td style="width:5%;"><a href="index.php?com=tinnho&act=edit16&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>
                    <td style="width:5%;"><a href="index.php?com=tinnho&act=delete16&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                  </tr>
                  <?php	
						}
					}
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
        <a href="index.php?com=tinnho&act=add16<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Tag</a>
                  <a href="index.php?com=tinnho&act=man16" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a> 
                </div>
