...
<!-- 
               ...
               <?php if ($_REQUEST['act']=='edit6'){?>
                ...
                <div class="col-md-2"><label>Logo thương hiệu</label></div>
          ...
          Width:244px - Height: 375px
              ...
              <!--   <?php if ($_REQUEST['act']=='edit6'){?>
                ...
                <div class="col-md-10"><img src="<?=_upload_tinnho.$item['logo']?>"  style="max-width:100%" alt="NO PHOTO" /><br /><br /></div>

                <?php }?><div class="clearfix"></div>

                <div class="col-md-2"><label>Banner thương hiệu</label></div>
...
<!-- 
                  ...
                  <div class="col-md-10"><?=get_loaicat($item['loai_cat']);?></div> -->
                ...
                <div class="tab-content">
                  ...
                  foreach ($config["lang"] as $key => $value) {
                    ...
                    <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                     ...
                     <div class="col-md-10"><input type="text" name="ten_<?= $value ?>" id="ten_<?= $value ?>" value="<?=$item['ten_'.$value]?>" placeholder="Tên <?= $config["langs"][$value]?>" /></div>

                     <div class="col-md-2"><label>Link <?= $config["langs"][$value]?></label></div>

                     <div class="col-md-10"><input type="text" name="chucvu_<?= $value ?>" id="chucvu_<?= $value ?>" value="<?=$item['chucvu_'.$value]?>" placeholder="Link <?= $config["langs"][$value]?>" /></div>
