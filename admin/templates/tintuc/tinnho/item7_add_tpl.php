  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man7">Mục hợp đồng</a></li>
    ...
    <!-- Inline Form Start -->
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=tinnho&act=save7<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">              
    ...
    <!--END NỘI DUNG ĐA NGÔN NGỮ -->
        ...
        <input type="hidden" name="id" id="id" value="<?=@$item['id']?>" />
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=tinnho&act=man7<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
