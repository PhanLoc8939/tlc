...
<div class="row breadcrumbs">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <ul class="breadcrumbs">
      ...
      <li><a href="index.php?com=tinnho&act=man9">Hỗ trợ thông tin</a></li>
...
<!--   <div class="inner" style="margin-bottom:10px;">
    ...
    <div class="message-box info">
      ...
      <p>Lưu ý: Chỉ để hiển thị 3 mục nổi bật được hiển thị ngoài trang chủ</p>
...
<!-- 
 <h4><a href="index.php?com=tinnho&act=add9<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm</a></h4>    -->   

</div>

<div class="col-md-4 paging_0px">  

 <form action="index.php?com=tinnho&act=man9<?=$chuoi_noi_curpage?>" method="post" class="inline-form">
  ...
  <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">            
      ...
      if(count($items)!=0){
        ...
        foreach($items as $k=>$v){
          ...
          <tr>
            ...
            <td><a href="index.php?com=tinnho&act=edit9&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_tinnho.$v['photo']?>" width="150px"/></a></td>                  

            <td><a href="index.php?com=tinnho&act=edit9&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten_vi']?></a></td>
            ...
            <!-- 	<td style="width:5%;"><a class="clickchange" thaydoiloai="noibat"   thaydoitable="table_tinnho"  thaydoiid="<?=$v['id']?>" id="idcssnoibat<?=$v['id']?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td> -->
                ...
                <td style="width:5%;"><a href="index.php?com=tinnho&act=edit9&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>

                <td style="width:5%;"><a href="index.php?com=tinnho&act=delete9&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
    ...
    <div class="col-md-12 margin_bottom_10px">
      ...
      <div class="col-md-4 paging_0px">                  
        ...
        <a href="index.php?com=tinnho&act=add9<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm</a>

        <a href="index.php?com=tinnho&act=man9" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a> 
