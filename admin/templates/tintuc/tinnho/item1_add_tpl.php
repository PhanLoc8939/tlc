...
<!-- Breadcrumbs Start -->
    ...
    <h4 class="header-title pt-20"><a href="index.php?com=tinnho&act=man1">PRICES</a></h4>
...
<button type="button" onclick="javascript:window.location='index.php?com=tinnho&act=man<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
              ...
              <!-- <?php if ($_REQUEST['act']=='edit'){?>
               ...
               <div class="col-md-2 pt-20"><label>Số thứ tự</label></div>

                <div class="col-md-10 pt-20"><input type="text" name="stt" id="stt" class="w-full txt-area" value="<?=isset($item['stt'])?$item['stt']:1?>" placeholder="Số thứ tự" /></div>
        ...
        <!-- 
           ...
           <!-- PHẦN DƯỚI LÀ DÀNH CHO NỘI DUNG ĐA NGÔN NGỮ-->
                ...
                <div class="clearfix"></div> 
                <br>
                <div class="col-md-2 pt-10"><label>c1 <?= $config["langs"][$value]?></label></div>
                <div class="col-md-10"><input type="text" class="w-full txt-area" name="chucvu_<?= $value ?>" id="chucvu_<?= $value ?>" value="<?=$item['chucvu_'.$value]?>" placeholder="c1" /></div>
                <div class="clearfix"></div> 
                <br>

                <div class="col-md-2 pt-10"><label>Giá <?= $config["langs"][$value]?></label></div>
                <div class="col-md-10"><input type="text" class="w-full txt-area" name="diachi_<?= $value ?>" id="diachi_<?= $value ?>" value="<?=$item['diachi_'.$value]?>" placeholder="Giá" /></div>
                <div class="clearfix"></div> 
                <br>
