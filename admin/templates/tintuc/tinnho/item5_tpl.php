...
<div class="row breadcrumbs">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <ul class="breadcrumbs">
      ...
      <li><a href="index.php?com=tinnho&act=man5">Tin tức xuất nhập khẩu</a></li>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  	 ...
  	 <!--  	<div class="inner" style="margin-bottom:10px;">
            ...
            <div class="message-box info">
              ...
              <p>Lưu ý: Chỉ để hiển thị 1 tin Nền danh mục!</p>
            ...
            <div class="inner">
              ...
              <div class="title-bar"> 
                ...
                <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	...
              	<h4><a href="index.php?com=tinnho&act=add5<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm </a></h4>      
              ...
              if(count($items)!=0){
                ...
                foreach($items as $k=>$v){
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=tinnho&act=edit5&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_tinnho.$v['photo']?>" width="150px"/></a></td>
     ...
     <div class="col-md-12 margin_bottom_10px">
      ...
      <div class="col-md-4 paging_0px">                  
       ...
       <a href="index.php?com=tinnho&act=add5<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm </a>
