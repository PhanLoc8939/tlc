...
<div class="main-content-inner ">
  <div class="row">
    ...
    <div class="w-full">
      <div class="card">
        <div class="card-body">
          <h4 class="header-title"><a href="index.php?com=tinnho&act=man3">TEAMM</a></h4>
          <div class="data-tables w-full">
            <table id="dataTable" class="text-center">
              ...
              <tbody>
                ...
                <tr>
                <td><?=$v['stt']?></td>   
                <td><a href="index.php?com=tinnho&act=edit3&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_tinnho.$v['photo']?>" width="150px"/></a></td>
                ...
                <td><a href="index.php?com=tinnho&act=edit3&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>
                <td><a href="index.php?com=tinnho&act=delete3&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td> 
                </tr>
                <?php }}?>
              </tbody>
            </table>
    ...
    <div class="col-md-12 margin_bottom_10px pt-10">
      ...
      <div class="col-md-4 paging_0px">                  
        ...
        <a href="index.php?com=tinnho&act=add3<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm</a> 
