           ...
           <!-- PHẦN DƯỚI LÀ DÀNH CHO NỘI DUNG ĐA NGÔN NGỮ-->
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                       ...
                       <div class="col-md-2"><label>Chức vụ <?= $config["langs"][$value]?></label></div>

                       <div class="col-md-10"><input type="text" name="chucvu_<?= $value ?>" id="chucvu_<?= $value ?>" value="<?=$item['chucvu_'.$value]?>" placeholder="Chức vụ" /></div>
