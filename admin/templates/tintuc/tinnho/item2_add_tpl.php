...
<!-- Breadcrumbs Start -->
    ...
    <h4 class="header-title pt-20"><a href="index.php?com=tinnho&act=man2">PROJECTS</a></h4>
          ...
          <div class=" w-full">
            ...
            <div class="inner">
              ...
              <?php if ($_REQUEST['act']=='edit'){?>
                ...
                <div class="col-md-10"><img src="<?=_upload_tinnho.$item['photo']?>"  width="250" alt="NO PHOTO" /><br /><br /></div>
