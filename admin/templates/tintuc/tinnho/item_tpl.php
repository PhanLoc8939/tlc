...
<div class="main-content-inner ">
  <div class="row">
    ...
    <div class="w-full">
      <div class="card">
        <div class="card-body">
          <h4 class="header-title"><a href="index.php?com=tinnho&act=man">SERVICES</a></h4>
              ...
              <tbody>
                <?php if (count($items) != 0) {
                  foreach ($items as $k => $v) { ?>
                    <tr>
                      <td><?= $v['stt'] ?></td>
                      <td><a href="index.php?com=tinnho&act=edit&id=<?= $v['id'] ?><?= $chuoi_noi_curpage ?>" style="text-decoration:none;"><img src="<?= _upload_tinnho . $v['photo'] ?>" width="150px" /></a></td>
                      ...
                      <td><a href="index.php?com=tinnho&act=edit&id=<?= $v['id'] ?><?= $chuoi_noi_curpage ?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>
                      <td><a href="index.php?com=tinnho&act=delete&id=<?= $v['id'] ?><?= $chuoi_noi_curpage ?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                    </tr>
                <?php }
                } ?>
              </tbody>
