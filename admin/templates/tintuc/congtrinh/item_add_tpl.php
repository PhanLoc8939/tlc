...
<script type="text/javascript">
  ...
  tinyMCE.init({
    ...
    mode : "exact",
        ...
        elements : "noidung_vi,noidung_en,mota_vi",
...
<!-- Breadcrumbs Start -->
  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=congtrinh&act=man">Hoạt động</a></li>
    ...
    <!-- Inline Form Start -->
        ...
        ?>               
              ...
              <form method="post" name="frm" action="index.php?com=congtrinh&act=save<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">
                    ...
                    <div class="col-md-10"><img src="<?=_upload_congtrinh.$item['photo']?>"  width="274" alt="NO PHOTO" /><br /><br /></div>
                ...
                <div class="clearfix"></div>
                   ...
                   <!--  <?php if ($_REQUEST['act']=='edit'){?>
                    ...
                    <div class="col-md-10"><img src="<?=_upload_congtrinh.$item['icon']?>"  width="274" alt="NO PHOTO" /><br /><br /></div>
 ...
 -->
            <div class="col-md-2"><label>URL</label></div>
                       ...
                       <div class="col-md-10"><input type="text" name="tenchudautu" id="tenchudautu" value="<?=$item['tenchudautu']?>" placeholder="Link" />
