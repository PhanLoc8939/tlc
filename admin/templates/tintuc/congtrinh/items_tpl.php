  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=congtrinh&act=man">Lĩnh vực hoạt động</a></li>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="inner" style="margin-bottom:10px;">
            ...
            <div class="message-box info">
              ...
              <p>Lưu ý: Slider nổi bật sẽ hiển thị ngoài trang chủ, có ít nhất 8 Slider.</p>
          ...
          <div class="inner">
            ...
            <div class="title-bar">
              ...
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	...
              	<h4><a href="index.php?com=congtrinh&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm </a></h4>      
            ...
            <div class="table-holder">                            
             ...
             <!--        <td style=" width:20%;">
                        ...
                        <b class="cap2">Cấp 2: <?php
							...
							$sql_danhmuc1="select ten from table_congtrinh_cat where id='".$v['id_cat1']."'";
                        ...
                        <b class="cap3">Cấp 3: <?php
							...
							$sql_danhmuc1="select ten from table_congtrinh_cat where id='".$v['id_cat2']."'";
                    ...
                    <td style="width:76px;"><a href="index.php?com=congtrinh&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=_upload_congtrinh.$v['photo']?>" border="1" class="" width="100px" /></a></td> 
                   ...
                   <td style="width:5%;"><a href="index.php?com=congtrinh&act=man_photo&id_cat=<?=$v['id']?>">Thêm +</a></td>
                    ...
                    <td style="width:5%;"><a class="clickchange" thaydoiloai="noibat"   thaydoitable="table_congtrinh"  thaydoiid="<?=$v['id']?>" id="idcssnoibat<?=$v['id']?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>

					<!-- <td style="width:5%;"><a class="clickchange" thaydoiloai="tinmoi"   thaydoitable="table_congtrinh"  thaydoiid="<?=$v['id']?>" id="idcsstinmoi<?=$v['id']?>"><img src="<?=($v['tinmoi']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>

                    --> <td style="width:5%;"><a class="clickhienthi" thaydoiloai="hienthi"   thaydoitable="table_congtrinh" thaydoiid="<?=$v['id']?>" id="idcsshienthi<?=$v['id']?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
			...
			<div class="col-md-12 margin_bottom_10px">
                ...
                <div class="col-md-6 paging_right_10px">                  
                 ...
                 <a href="index.php?com=congtrinh&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm</a>
