  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=about&act=capnhap2">PROJECTS</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <!--   <?php if ($_REQUEST['act']=='capnhap2'){?>
                <div class="col-md-2"><label>Hình ảnh Hiện tại</label></div>
...
<!-- 
                ...
                <div class="clearfix"></div>
                <div class="col-md-2"><label>Banner lớn</label></div>
                <div class="col-md-10">
       ...
       -->
           ...
           <?php
               ...
               <!--    <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                    ...
                    <div class="col-md-10"><input name="ten_<?= $value ?>" id="ten_<?= $value ?>" placeholder="Tên " value="<?=$item['ten_'.$value]?>"><br /></div>

                       -->

                      <div class="col-md-2"><label>Mô tả <?= $config["langs"][$value]?> </label></div>
                        <div class="col-md-10"><textarea name="mota_<?= $value ?>" id="mota_<?= $value ?>" placeholder="Mô tả" cols="50" rows="5"><?=$item['mota_'.$value]?></textarea><br /></div>
