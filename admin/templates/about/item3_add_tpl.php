<script type="text/javascript">
  ...
  tinyMCE.init({
    ...
    elements : "noidung_vi,noidung_en,noidung_cn,noidung_hq,mota_vi,mota_en",
...
<div class="row breadcrumbs">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <ul class="breadcrumbs">
      ...
      <li><a href="index.php?com=about&act=capnhap3">Manufacturing</a></li>
    	...
    	<!--<div class="inner" style="margin-bottom:10px;">
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=about&act=save3" enctype="multipart/form-data" class="basic-form inline-form">                              
...
<!-- 
                ...
                <div class="col-md-10"><input type="text" name="h1_vi" id="h1_vi" value="<?=$item['h1_vi']?>" placeholder="" />
...
<!-- 
                ...
                <div class="col-md-2"><label>Video hiện tại</label></div>

                <div class="col-md-10"><img src="<?=_upload_tinnho.$item['photo1']?>"  width="300" alt="NO PHOTO" /><br /><br /></div>
...
<!-- 
                ...
                <div class="col-md-10"><img src="<?=_upload_tinnho.$item['photo2']?>"  width="300" alt="NO PHOTO" /><br /><br /></div>
                ...
                <div class="col-md-2"><label>Hình 3</label></div>
                ...
                <div class="col-md-10"><img src="<?=_upload_tinnho.$item['photo3']?>"  width="300" alt="NO PHOTO" /><br /><br /></div>
                ...
                <div class="col-md-2"><label>Hình 4</label></div>
              ...
              <div class="tab-content">
                ...
                foreach ($config["lang"] as $key => $value) {
                  ...
                  <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
                    ...
                    <div class="col-md-2"><label>Tiêu đề <?= $config["langs"][$value]?></label></div>
                    ...
                    <div class="col-md-10"><textarea name="mota_<?= $value ?>" id="mota_<?= $value ?>" placeholder="Mô tả"><?=$item['mota_'.$value]?></textarea><br /></div>
              ...
              <div class="col-md-10 col-md-offset-2">                  
                ...
                <button type="button" onclick="javascript:window.location='index.php?com=about&act=capnhap3'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
