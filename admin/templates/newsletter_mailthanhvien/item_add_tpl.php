...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <h4 class="header-title "><a href="index.php?com=newsletter_mailthanhvien=man" title="Email đăng ký">Email đăng ký</a></h4>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="inner">
      ...
      <form method="post" name="frm" action="index.php?com=newsletter_mailthanhvien=save<?= $chuoi_noi_curpage ?>" enctype="multipart/form-data" class="basic-form inline-form">

        <div class="col-md-2 pt-10"><label>Họ tên </label></div>
        <div class="col-md-10"><input type="text" name="hoten" class="w-full txt-area" value="<?= $item['hoten'] ?>" placeholder="Họ tên" /></div>
        ...
        <div class="col-md-2 pt-10"><label>Mô Tả </label></div>
        <div class="col-md-10"><input type="text" name="tinnhan" class="w-full txt-area" value="<?= $item['tinnhan'] ?>" placeholder="Mô Tả" /></div>
        <div class="clearfix"></div>
        <br>

        <div class="col-md-2 pt-10"><label>Nội Dung </label></div>
        <div class="col-md-10"><input type="text" name="noidung" class="w-full txt-area" value="<?= $item['noidung'] ?>" placeholder="Nội Dung" /></div>
        <div class="clearfix"></div>
        <br>
        ...
        <div class="col-md-10 col-md-offset-2">
          ...
          <button type="button" onclick="javascript:window.location='index.php?com=newsletter_mailthanhvien=man<?= $chuoi_noi_curpage ?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
        </div>
