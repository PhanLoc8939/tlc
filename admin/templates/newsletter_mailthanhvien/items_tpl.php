  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=newsletter_mailthanhvien&act=man" title="Email đăng ký">Danh sách email đăng ký</a></li>
          ...
          <div class="inner">
            ...
            <div class="title-bar">               
              ...
              <div class="col-md-4 paging_0px">  
              	...
              	<form action="index.php?com=newsletter_mailthanhvien&act=man<?=$chuoi_noi_curpage?>" method="post" class="inline-form">
            ...
            <form name="frm" method="post" action="index.php?com=newsletter_mailthanhvien&act=send" enctype="multipart/form-data">		    
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width:5%;"><input type="checkbox" name="chon" id="chon" value="<?=$v['id']?>" class="chon" /></td>                    
					            ...
					            <td><b><a href="index.php?com=newsletter_mailthanhvien&act=edit&id=<?=$v['id']?>"><?=$v['email']?></a></b></td>


              
                    <td style="width:5%;"><a href="index.php?com=newsletter_mailthanhvien&act=delete&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
			...
			<div class="col-md-12 margin_bottom_10px">
                ...
                <div class="col-md-4 paging_0px">                  
                  ...
                  <a href="index.php?com=newsletter_mailthanhvien&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-plus"></i> Thêm email</a>                  
