  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=photo&act=man_chiase">Hỗ trợ trực tuyến</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
            ...
            <div class="inner">
             ...
             <!--    <div class="col-md-2"><label>Tên</label></div>
                <div class="col-md-10"><input type="text" name="ten" value="<?=$item['ten']?>" placeholder="Tên" /></div>
                      ...
                      <div class="col-md-2"><label>Phone hỗ trợ</label></div>
                <div class="col-md-10"><input type="text" name="ten1" value="<?=$item['ten1']?>" placeholder="" />
              ...
              <!--      <div class="col-md-2"><label>Link Facebook</label></div>
                <div class="col-md-10"><input type="text" name="ten2" value="<?=$item['ten2']?>" placeholder="Ví dụ: http://vietit.vn/" />
                  <span class="description">Ví dụ: http://vietit.vn/</span>
                    <br /><br />
                </div> -->
