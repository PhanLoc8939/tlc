  ...
  <div class="row breadcrumbs">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=photo&act=man_lkweb">Banner trang con</a></li>
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
             ...
             <?php if ($_REQUEST['act']=='edit_lkweb'){?>
                ...
                <div class="col-md-10"><img src="<?=_upload_hinhanh.$item['photo']?>"  height="47" alt="NO PHOTO" /><br /><br /></div>
                ...
                <div class="col-md-10">
                    ...
                    <span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp; Ảnh chuẩn: Width:47px - Height:47px</span>
