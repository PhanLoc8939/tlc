		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=photo&act=save1_video<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">  
              	<?php if ($_REQUEST['act']=='edit1_video'){?>
                <div class="col-md-2"><label>Video hiện tại</label></div>
                <div class="col-md-10"><?=$item['download']?><br /><br /></div>
                <?php }?>
            ...
            <!--     <div class="col-md-2"><label>Link Đối tác</label></div>
                <div class="col-md-10"><input type="text" name="link" value="<?=$item['link']?>" placeholder="Ví dụ: https://zingnews.vn/" />
                	<span class="description">Ví dụ: https://zingnews.vn/</span>
                    <br /><br />
                </div> -->
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=photo&act=man1_video<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
