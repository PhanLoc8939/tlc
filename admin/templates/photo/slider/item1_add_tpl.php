...
<div class="row breadcrumbs">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <ul class="breadcrumbs">
      ...
      <li><a href="index.php?com=photo&act=man1">Banner</a></li>
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=photo&act=save1<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">  
                  ...
                  <div class="col-md-10"><img src="<?=_upload_hinhanh.$item['photo']?>"  width="400" alt="NO PHOTO" /><br /><br /></div>
                ...
                <div class="col-md-10"><input type="text" name="stt" id="stt" value="<?=isset($item['stt'])?$item['stt']:1?>" placeholder="Số thứ tự" />
                </div>
