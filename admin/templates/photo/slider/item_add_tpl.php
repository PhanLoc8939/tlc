...
<div class=" w-full">
  <div class=" inner">
    <form method="post" name="frm" action="index.php?com=photo&act=save<?= $chuoi_noi_curpage ?>" enctype="multipart/form-data" class="basic-form inline-form  pt-20 "">              
    <input type=" hidden" name="id" id="id" value="<?= @$item['id'] ?>" style="display: none;" />
