		...
		<!-- Inline Form Start -->
          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
             ...
             <?php if ($_REQUEST['act']=='edit_hotline'){?>

                <div class="col-md-2"><label>Ảnh banner </label></div>

                <div class="col-md-10"><img src="<?=_upload_hinhanh.$item['photo']?>" style=" max-width:100%;" alt="NO PHOTO" /><br /><br /></div>
                ...
                <div class="col-md-10">
                    ...
                    <span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp;1366px - 400px</span>
