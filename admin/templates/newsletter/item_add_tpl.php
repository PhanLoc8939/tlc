          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=newsletter&act=save<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">                             
                ...
                <div class="col-md-2"><label>Danh xưng </label></div>
                <div class="col-md-10"><input type="text" name="danhxung" value="<?=$item['danhxung']?>" placeholder="Danh xưng" /></div>

                <div class="col-md-2"><label>Chức vụ </label></div>
                <div class="col-md-10"><input type="text" name="chucvu" value="<?=$item['chucvu']?>" placeholder="Chức vụ" /></div>

                <div class="col-md-2"><label>Tên doanh nghiệp </label></div>
                <div class="col-md-10"><input type="text" name="tencty" value="<?=$item['tencty']?>" placeholder="Tên doanh nghiệp" /></div>
                ...
                <div class="col-md-10"><input type="text" name="dienthoai" value="<?=$item['dienthoai']?>" placeholder="Điện thoại" /></div>
