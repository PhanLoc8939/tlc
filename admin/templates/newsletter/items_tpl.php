                ...
                if(count($items)!=0){
                  ...
                  foreach($items as $k=>$v){
                    ...
                    <tr>
                      ...
                      <td><b><a href="index.php?com=newsletter&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><?=$v['hoten']?></a></b></td> 

                      <td><b><a href="index.php?com=newsletter&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><?=$v['email']?></a></b></td>
