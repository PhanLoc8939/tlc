...
<div class="w-full">
  ...
  <div class="boxed no-padding w-full">
      ...
      <form method="post" name="frm" action="index.php?com=company&act=save_capnhap" enctype="multipart/form-data"
        class="basic-form inline-form" style="padding:10px;">
        ...
        foreach ($config["lang"] as $key => $value) {
          ...
          <div class="tab-pane <?=$active?>" id="tab<?= $value ?>">
            ...
            <div class="col-md-10"><textarea class="w-full txt-area" name="ten_<?=$value?>" cols="50" rows="3"
                id="ten_<?=$value?>" placeholder="Tên công ty"><?=@$item['ten_'.$value]?></textarea><br /></div>
            ...
            <div class="col-md-10"><textarea class="w-full txt-area" name="tieude_<?=$value?>" cols="50" rows="3"
                id="tieude_<?=$value?>" placeholder="Tên công ty"><?=@$item['tieude_'.$value]?></textarea><br /></div>
            ...
            <div class="col-md-10"><textarea class="w-full txt-area" name="mota_<?=$value?>" cols="50" rows="5"
                id="mota_<?=$value?>" placeholder="Thông tin footer"><?=@$item['mota_'.$value]?></textarea><br /></div>
            ...
            <div class="col-md-10"><textarea class="w-full txt-area" name="noidung_<?= $value ?>"
                id="noidung_<?= $value ?>" placeholder="Thông tin footer"><?=$item['noidung_'.$value]?></textarea><br />
            </div>
            ...
            <div class="col-md-10"><input class="w-full txt-area" type="text" name="title_<?= $value ?>"
                id="title_<?= $value ?>" value="<?=$item['title_'.$value]?>" placeholder="Title" /></div>
            <div class="clearfix"></div>
            <br>
            ...
            <div class="col-md-10"><textarea class="w-full txt-area" name="keywords_<?= $value ?>" cols="50" rows="6"
                placeholder="Keywords"><?=$item['keywords_'.$value]?></textarea></div>
            <div class="clearfix"></div>
            <br>
            <div class="col-md-2 pt-10 "><label>Description <?=$config["langs"][$value]?></label></div>

            <div class="col-md-10"><textarea class="w-full txt-area" name="description_<?= $value ?>" cols="50" rows="6"
                placeholder="Description"><?=$item['description_'.$value]?></textarea></div>
            <div class="clearfix"></div>
            <br>
...
<!-- 
        ...
        <div class="col-md-10 "><input class="w-full txt-area" type="text" name="copyright" id="copyright"
            value="<?=$item['copyright']?>" placeholder="copyright " /></div>
 ...
 -->
        ...
        <div class="col-md-10 "><input class="w-full txt-area" type="text" name="dienthoai" id="dienthoai"
            value="<?=$item['dienthoai']?>" placeholder="Hotline 1" /></div>
        <div class="clearfix"></div>
        <br>
...
<br>
        ...
        <div class="col-md-10 "><input class="w-full txt-area" type="text" name="email" id="email"
            value="<?=$item['email']?>" placeholder="Email" /></div>
        <div class="clearfix"></div>
        <br>
        ...
        <div class="col-md-10"><img src="<?=_upload_company.$item['favicon']?>" style="max-width:100%"
        ...
        <div class="col-md-10"><img src="<?=_upload_company.$item['logore']?>" style="max-width:100%"
            alt="NO PHOTO" /><br /><br /></div>
        ...
        <div class="col-md-10"><img src="<?=_upload_company.$item['logofooter']?>" style="max-width:100%"
            alt="NO PHOTO" /><br /><br /></div>
        ...
        <div class="col-md-10 paging_0px"><textarea class="w-full txt-area" name="script" cols="50" rows="15"
            placeholder="Dán code Google Analytics và Google Webmaster vào đây ... "><?=$item['script']?></textarea>
        </div>
        <div class="clearfix"></div>
        <br>
        ...
        <div class="col-md-10 paging_0px"><textarea class="w-full txt-area" name="vchat" cols="50" rows="15"
            placeholder="Dán code vchat vào đây ... "><?=$item['vchat']?></textarea></div>
        <div class="clearfix"></div>
        <br>
        ...
        <div class="col-md-10 col-md-offset-2 paging_0px">
          ...
          <button type="button" onclick="javascript:document.frm.submit()" class="btn btn-success"><i
              class="fa fa-check"></i> Lưu thông tin</button>

          <button type="button" onclick="javascript:window.location='index.php'" class="btn btn-info"><i
              class="fa fa-share"></i> Thoát</button>
