<?php
	...
	function get_price($pid){
		...
		$sql = "select gia,loaikm,id from table_product where id=$pid";
	...
	function addtocart($pid,$q,$mausacgh){
		...
		if(is_array($_SESSION['cart'])){
			...
			$_SESSION['cart'][$max]['mausacgh']=$mausacgh;
			...
			$_SESSION['cart'][0]['productid']=$pid;
			 ...
			 $_SESSION['cart'][0]['mausacgh']=$mausacgh;
	...
	function product_exists($pid,$q,$mausacgh){
		...
		for($i=0;$i<$max;$i++){
			...
			if($pid==$_SESSION['cart'][$i]['productid']&&$mausacgh==$_SESSION['cart'][$i]['mausacgh']){
