...
function coutncauhinh($id_sp){

	global $d;

	$sql="select count(id) as total from #_product_cauhinh where id_cat=$id_sp";
...
function listproduct_idc($pid){
	...
	function get_tenkhoahoc($pid){

		global $d, $row;

		$sql = "select ten_vi from #_tin3cap where id=$pid";
