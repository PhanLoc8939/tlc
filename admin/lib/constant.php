...
@define ( _upload_hinhdinhkem, '../upload/hinhdinhkem/' );
@define ( _upload_hinhdinhkem_l , 'upload/hinhdinhkem/' );
...
@define ( _upload_company , '../upload/company/' );
@define ( _upload_company_l , 'upload/company/' );
...
@define ( _upload_khuyenmai , '../upload/khuyenmai/' );
@define ( _upload_khuyenmai_l , 'upload/khuyenmai/' );
@define ( _upload_member , '../upload/member/' );
@define ( _upload_member_l , 'upload/member/' );
