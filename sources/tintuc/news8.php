<?php  if(!defined('_source')) die("Error");								
		...
		if(isset($_REQUEST['idc'])){	//Chi tiết
			...
			$sql_tintuc = "select * from #_tinnho where hienthi=1 and id='$id' and com=8";
			...
			$sql_update = "update #_tinnho SET luotxem=$luotxem where id='$id' and com=8";
			...
			$sql = "select * from #_tinnho where hienthi=1 and id<>'$id' and com=8 order by stt asc,id desc";
			...
			$sql_tintuc = "select * from #_tinnho where hienthi=1 and com=8 order by stt asc, id desc limit 0,50";					
