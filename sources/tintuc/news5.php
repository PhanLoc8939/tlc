<?php  if(!defined('_source')) die("Error");								
		...
		if(isset($_REQUEST['idc'])){	//Chi tiết
			...
			$sql_tintuc = "select * from #_tinnho where hienthi=1 and id='$id' and com=5";
			...
			$sql = "select * from #_tinnho where hienthi=1 and id<>'$id' and com=5 order by stt asc,id desc";
			...
			$sql_tintuc = "select * from #_tinnho where hienthi=1 and com=5 order by stt asc, id desc";					

			$d->query($sql_tintuc);

			$news = $d->result_array();

			$title_ttt ='Tin tức xuất nhập khẩu';		
