					...
					$nam=$ngaysinh[2];
						...
						if(isset($_POST['luuthongtin'])){
...

								{
									 ...
									 transfer("Email hoặc điện thoại không được để trống ","thong-tin-user.html");	
...

								{
...

										{
											  ...
											  transfer("Địa chỉ email không phù hợp","thong-tin-user.html");	
...

								{
									 ...
									 transfer("Họ tên không được để trống","thong-tin-user.html");	
...

								{
									...
									if(q_isnumber($dienthoaiedit)==0){
										...
										transfer("Số điện thoại không phù hợp","thong-tin-user.html");	
...

									{
										...
										$d->setWhere('id', $user['id']);
											...
											transfer("Thay đổi thông tin không thành công!", "thong-tin-user.html");		
