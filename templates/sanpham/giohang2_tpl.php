...
<div id="giohang">
    ...
    ?>
        ...
        text-shadow: 0px 0px 0px #2d5c00;">Gợi ý dành riêng cho bạn</p>
                        <div id="owl-spchitiet" class="owl-carousel">
                        <?php foreach ($product_khac as $v1) {?>
                              <div class="spdeal" style="border:none">

                                  <div class="hinhdeals">
                                      <a href="<?=$v1['tenkhongdau_vi']?>-<?=$v1['id']?>.htm"><img style="width: auto;" src="thumb/300x300/2/<?=_upload_sanpham_l.$v1['photo']?>"></a>
                                  </div>
                                  <div class="tieudedeal">
                                      <h3><a href="<?=$v1['tenkhongdau_vi']?>-<?=$v1['id']?>.htm"><?=$v1['ten_vi']?></a></h3>
                                  </div>
                                  <div class="giadeal">
                                      <span><?=($v1['gia']!=0)?(number_format($v1['gia'],0, ',', ',')." đ"):'Liên hệ' ?></span>
                                  </div>
      ...
      <!-- san pham da xem -->
        <?php include_once _template."layout/sanphamdaxem.php"; ?>
      <!-- end san pham đã xem -->
