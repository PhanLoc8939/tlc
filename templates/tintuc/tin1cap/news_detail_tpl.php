<section class="width_100 content_detail">
    ...
    <div class="container container1">
        ...
        <div class="width_100 ngaytao-bv nav-bredcrum "> <a href="" title="Trang chủ">
         <?=_trangchu?>            </a> <i class="fa fa-angle-double-right"></i> <a href="#" > <?=_linhvuchoatdong?> </a> <i class="fa fa-angle-double-right"></i> <span>
         <?=$news['ten_'.$lang]?>             </span> 
       </div>
        ...
        <div class="news_related width_100">
           ...
           <ul>
                  <?php foreach ($newskhac as $key => $v) {?>
                             <li>
                                <a href="<?=$v['tenkhongdau']?>-<?=$v['id']?>.htm" title="<?=$v['ten_vi']?>">
                                <?=$v['ten_'.$lang]?> 
                                </a>
                             </li>
                           <?php } ?>
