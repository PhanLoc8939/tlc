            ...
            <div class="content_detail width_100" >
              <?php if($_REQUEST['idc']=='') {?>
                <div class="width_100 ngaytao-bv nav-bredcrum "> 
                  ...
                  <li><a href="bao-gia.html" title="<?=$title_ttt?>"><?=$title_ttt?> </a>         
                  </li> 
                </div>
                ...
                <div class="grid-2tinlq">
                  <?php foreach ($news as $v) {?>
                    <div class="items-tt">
                      <div class="img-tt">
                        <a href="bao-gia/<?=$v['tenkhongdau_vi']?>-<?=$v['id']?>.html"><img src="thumb/280x210/1/<?=_upload_tinnho_l.$v['photo']?>"></a>
                      </div>
                      <div class="content-tt">
                        <div class="name-tt">
                          <a href="bao-gia/<?=$v['tenkhongdau_vi']?>-<?=$v['id']?>.html"><?=$v['ten_vi']?></a>
                        </div>
                        ...
                        <div class="read-more-news">
                          <a href="bao-gia/<?=$v['tenkhongdau_vi']?>-<?=$v['id']?>.html">Xem thêm</a>
                        </div>
                      </div>              
                    </div>
                  <?php }?>
              ...
              <?php }else{?>
                <div class="width_100 ngaytao-bv nav-bredcrum "> 
                  <li><a href="" title="Trang chủ"> Trang chủ </a><i class="fa fa-angle-double-right"></i></li>
                  <li><a href="bao-gia.html" title="Báo giá">Báo giá</a> <i class="fa fa-angle-double-right"> </i></li>
                  <li><a href="bao-gia/<?=$news['tenkhongdau_vi']?>-<?=$news['id']?>.html" title="<?=$title_ttt?>"><?=$title_ttt?> </a>         
                  </li> 
                </div>
                <div class="title-product2 width_100">
                  <h1 style="text-align: center;"><?=$title_ttt?></h1>
